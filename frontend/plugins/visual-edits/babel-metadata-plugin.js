...
const babelMetadataPlugin = ({ types: t }) => {
    ...
    const pushMetaAttrs = (
        openingEl, { normalizedPath, lineNumber, elementName, isDynamic }, { markExcluded = false } = {},
    ) => {
        ...
        visitor: {
            ...
            JSXElement(jsxPath, state) {
                ...
                if (
                    ...
                    pushMetaAttrs(
                        openingElement, { normalizedPath, lineNumber, elementName, isDynamic }, { markExcluded: true },
                    );
                    return;
                }
                ...
                const wrapper = t.jsxElement(
                    ...
                    t.jsxClosingElement(t.jsxIdentifier("div")), [jsxPath.node],
                    false,
                );
